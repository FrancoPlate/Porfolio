...
export default function Present() {
  const downloadPDF = () => {
    ...
    //ruta de donde esta el pdf
    link.href = '/CVFrancoPlate.pdf';
    // Atributos del pdf
    link.setAttribute('download', 'Franco_Plate_CV.pdf');
  ...
  return (
    <div className='App-presen'>
            ...
            <div className='App-Buttons'>
              <button className='App-ButCV' onClick={downloadPDF}>
              <svg
              ...
              {/* aqui flecha arriba :D */}
              <a href='https://github.com/FrancoPlate/Porfolio.git' className='App-ButCircle' target="_blank" rel="noopener noreferrer">
              ...
              <a href='https://www.linkedin.com/in/franco-plate' className='App-ButCircle' target="_blank" rel="noopener noreferrer" >
              ...
              <a href="mailto:francoplatepaz@gmail.com?subject=Consulta%20desde%20tu%20portfolio&body=Hola%20Franco%2C%20quiero%20contactarte..." className='App-ButCircle' target="_blank" rel="noopener noreferrer">
